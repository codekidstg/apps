...
const adminNav: NavItem[] = [
  ...
  { label: "Messages des parents", href: "/admin/messages", icon: "✉️", pageKey: "admin.messages" },
  {
    ...
    children: [
      ...
      { label: "Justificatifs", href: "/admin/compta/justificatifs", pageKey: "admin.compta.justificatifs" },
    ],
  },
...
const managerNav: NavItem[] = [
  ...
  { label: "Affectations",    href: "/manager/affectations",  icon: "📋", pageKey: "manager.affectations" },
  {
    ...
    children: [
      ...
      { label: "Justificatifs", href: "/manager/compta/justificatifs", pageKey: "manager.compta.justificatifs" },
    ],
  },
...
const teacherNav: NavItem[] = [
  ...
  { label: "Questions des élèves", href: "/prof/questions", icon: "🙋", pageKey: "teacher.questions" },
