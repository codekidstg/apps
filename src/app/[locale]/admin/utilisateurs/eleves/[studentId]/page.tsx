...
export default async function StudentDetailPage({
  ...
  // Le dénominateur était le nombre de lignes de suivi : il grandissait à
  // chaque leçon ouverte, si bien qu'avancer faisait baisser le pourcentage.
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-2 flex-wrap">
            ...
            <span className="text-xs text-gray-500 font-bold">
              📖 {parcours.faites}/{parcours.total} leçons
