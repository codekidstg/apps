...
export default async function ManagerStudentDetailPage({
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <Link href={`/${locale}/manager/utilisateurs/eleves`} className="inline-flex items-center gap-1.5 text-xs font-bold text-gray-400 hover:text-gray-700 transition-colors">
        ← Retour aux élèves
      </Link>
