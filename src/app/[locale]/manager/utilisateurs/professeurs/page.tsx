...
export default async function ManagerProfesseursPage() {
                    ...
                    <div className="mb-4">
                      <div className="grid grid-cols-7 gap-1 mb-1">
                        {weekdayOrder.map((wd) => {
                          ...
                          return (
                            <div key={wd} className={`rounded-xl text-center transition-all ${hasSession ? "bg-brand-navy shadow-sm" : "bg-gray-50"}`}>
                        ...
                        return (
                          <div key={s.id} className="group flex items-center gap-2.5 bg-amber-50 border border-amber-100 rounded-xl px-3 py-2">
                            <div className="text-center shrink-0 w-8">
                              <div className="text-[9px] font-black text-amber-400 uppercase">{at.toLocaleDateString("fr-FR", { month: "short" })}</div>
