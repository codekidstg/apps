...
export const NAV_PAGES: NavPageDef[] = [
  ...
  { role: "admin", key: "admin.utilisateurs.professeurs", label: "↳ Mentors",       href: "/admin/utilisateurs/professeurs",  parentKey: "admin.utilisateurs" },
  ...
  { role: "admin", key: "admin.mentors",                  label: "Suivi des mentors", href: "/admin/mentors",                  icon: "🧑‍🏫" },
  { role: "admin", key: "admin.questions",                label: "Questions des élèves", href: "/admin/questions",             icon: "🙋" },
  { role: "admin", key: "admin.messages",                 label: "Messages des parents", href: "/admin/messages",              icon: "✉️" },
  ...
  { role: "manager", key: "manager.utilisateurs.professeurs", label: "↳ Mentors",       href: "/manager/utilisateurs/professeurs",  parentKey: "manager.utilisateurs" },
  ...
  { role: "manager", key: "manager.mentors",                  label: "Suivi des mentors", href: "/manager/mentors",                   icon: "🧑‍🏫" },
  { role: "manager", key: "manager.questions",                label: "Questions des élèves", href: "/manager/questions",             icon: "🙋" },
  { role: "manager", key: "manager.messages",                 label: "Messages des parents", href: "/manager/messages",              icon: "✉️" },
